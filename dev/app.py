...
duckduckgo_search = Tool(
    ...
    func=lambda x: DuckDuckGoSearchRun().run(x),
    description="useful for when you need to answer questions about current events or find data",
)

# Define the create_crewai_setup function with Ollama
